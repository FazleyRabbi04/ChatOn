            ...
            public void actionPerformed(ActionEvent e) {
                ...
                b4.addActionListener(new ActionListener() {
                    ...
                    public void actionPerformed(ActionEvent e) {
                        ...
                        fc.setCurrentDirectory(new File("C:\\Users\\akmfa\\OneDrive\\Pictures"));
                    ...
                    if(mobileNumber.getText().length() == 11) {
                        ...
                        if(trigger == 0) {
                            if(new String(password.getPassword()).length() < 4) {
                                ...
                                //finds the user, checks their .dat file and extracts the password to match with given nfoi
                                ...
                                if(temp.getPassword().equals(new String(password.getPassword()))) {
                                    ...
                                    b8.addActionListener(new ActionListener() {
                                        ...
                                        public void actionPerformed(ActionEvent e) {
                                            dispose();
                                            //THIS IS THE PLACE WHEREAUNC IT WILL LH THE CHAT WINDOW USING THE USERNAME AND AVATAR NAME FROM "temp"
                                            Socket socket =null;
                                            try {
