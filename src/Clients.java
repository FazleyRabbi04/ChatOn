...
public class Clients extends JFrame implements ActionListener ,KeyListener,Runnable{
    ...
    // Do our code Here in actionPerformed
    @Override
    ...
    //  Do Same code  Also inside the if
    @Override
    ...
    // If The Port Is in use in laptop then try different port which will be same on both server and client class
